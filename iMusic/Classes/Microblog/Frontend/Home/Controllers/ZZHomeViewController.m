...
//Microblog_Localization.strings
...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self)
    {
        ...
        self.title = NSStringLocalizedWB(@"homeVC_title", @"");
        //SLocalizedStringFromTable(@"homeVC_title", @"Microblog_Localization", @"");
    }
    return self;
}
